...
{    
    ...
    public class Lua : IDisposable
	{
        ...
        CSharpFunctionDelegate panicCallback, lockCallback, unlockCallback;
        ...
        /// Not yet used
        int LockCallback(ILuaState luaState)
        {
        ...
        /// <param name="luaState"></param>
        /// Not yet used
        int UnlockCallback(ILuaState luaState)
        {
        ...
        static int PanicCallback(ILuaState luaState)
        {
		...
		public LuaFunction GetFunction(string fullPath) 
		{
			...
			return (obj is CSharpFunctionDelegate ? new LuaFunction((CSharpFunctionDelegate)obj,this) : (LuaFunction)obj);
		}
		/*
        ...
        public LuaFunction RegisterFunction(string path, object target, MethodBase function /*MethodInfo function*/)  //CP: Fix for struct constructor by Alexander Kappner (link: http://luaforge.net/forum/forum.php?thread_id=2859&forum_id=145)
		{
			...
			translator.push(luaState,new CSharpFunctionDelegate(wrapper.call));
